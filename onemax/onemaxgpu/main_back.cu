...
int main()
{
    ...
    */
    ...
    cudaMalloc((void **)&dev_tournament_rand1, TOURNAMENT_SIZE * sizeof(int));
    cudaMalloc((void **)&dev_tournament_rand2, TOURNAMENT_SIZE * sizeof(int));
    /*
    ...
    */
    ...
    //- WHY: ここにmutationがある理由がわからない。削除してよいのでは?
    ...
    */
        ...
        //- セレクション：各個体をスレッドに処理させる
        selection<<<1, POPSIZE>>>(
                pdev_Fitness,
                pdev_SortedId,
                dev_tournament_rand1,
                dev_tournament_rand2,
                pdev_Parent1,
                pdev_Parent2,
                gen,
